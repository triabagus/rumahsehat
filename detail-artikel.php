...
<?php 
    ...
    if(isset($_GET['kd'])){
        $id = $_GET['kd'];
        if(preg_match("/'|onion|%27|order|-- -/",$id)){
            echo "<script>window.location = 'http://shafou.com'</script>";
            exit();
        }
...
$totalRows_Recordset1 = mysql_num_rows($Recordset1);
	...
	<div class="row-padding">
     <?php do { ?><div class="txt-dewe txt-margin-bottom" style="width:90%;">
		<center><h1 style="color:#009688;"><?php echo $row_Recordset1['judul'];?></h1></center>
		<div style="width:50%;">
      <img align="left" src="apoteker/image-artikel/<?php echo $row_Recordset1['gambar'];?>" alt="Norway" style="width:90%;height:auto;margin:0px 10px 0px 0px;">
	  </div>
      <div class="txt-container white">
        <p align="left" class="w3-opacity"><?php echo $row_Recordset1['sub_title'];?></p>
		<p align="justify" class="w3-opacity"><?php echo $row_Recordset1['isi'];?></p>
