...
if (isset($_POST['textfield'])) {
  ...
  $MM_redirectLoginSuccess = "apoteker/index.php";
  $MM_redirectLoginFailed = "login-admin-false.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_koneksi, $koneksi);
  
  $LoginRS__query=sprintf("SELECT username, password FROM tb_apoteker WHERE username=%s AND password=%s",
...
<form id="form1" class="modal-content" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
		...
		<center><p class="judul" style="color:#e91e63;">Apoteker</center>
	</div>
		<div class="con" style="color:red;">
			<center>* Nama Pengguna atau Kata Sandi anda salah</center>
		</div>
	<div class="con">
		Nama Pengguna<label for="textfield"></label> 
		...
		<a class="cancelbtn" style="padding:15px 15px;margin:10px 0px;" href="login-user.php"><i class="fa fa-arrow-circle-left"></i> Kembali</a> 
	</div>
</form>
</div>
</body>
