...
$query_Recordset1 = sprintf("SELECT * FROM tb_pasien WHERE nm_pasien LIKE %s", GetSQLValueString("%" . $colname_Recordset1 . "%", "text"));
...
<div style="float:left;margin:15px;">
   <a class="tambah" href="input-pasien.php"><i class="fa fa-plus-circle" style="color:white;"></i> Tambah</a>
 </div>
...
<table width="100%" border="1">
  ...
  <?php do { ?>
    <tr>
      ...
      <td style="padding: 10px;"><?php echo $row_Recordset1['telp']; ?></td>
