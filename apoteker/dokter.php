...
<a class="tambah" href="input-dokter.php"><i class="fa fa-plus-circle"></i> Tambah</a>
</div>
...
<table width="100%" border="1">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a class="hapus" onclick="return confirm('Apakah anda ingin menghapus data ini');" href="delete-dokter.php?kd_dokter=<?php echo $row_Recordset1['kd_dokter']; ?>">Hapus</a></td>
    </tr>
