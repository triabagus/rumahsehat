...
$query_Recordset1 = "SELECT * FROM tb_artikel";
...
<div style="float:left;margin:15px;">
   <a class="tambah" href="input-artike.php"><i class="fa fa-plus-circle"></i> Tambah</a>
 </div>
...
<p>
	...
	<a class="pagination" href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, min($totalPages_Recordset1, $pageNum_Recordset1 + 1), $queryString_Recordset1); ?>">Selanjutnya <i class="fa fa-arrow-circle-right"></i></a></p>
</div>
</body>
</html>
<?php
