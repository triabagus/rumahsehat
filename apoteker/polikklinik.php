...
$query_Recordset1 = "SELECT * FROM tb_poliklinik";
...
<a class="tambah" href="input-poli.php"><i class="fa fa-plus-circle"></i> Tambah</a>
</div>
...
<table width="100%" border="1">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><img src="../apoteker/image-poli/<?php echo $row_Recordset1['image']; ?>" width="50" height="50" /></td>
      <td><a class="ubah" href="update-poli.php?kd_plk=<?php echo $row_Recordset1['kd_plk']; ?>">Ubah</a></td>
      <td><a class="hapus" onclick="return confirm('Apakah anda ingin menghapus data ini');" href="delete-poli.php?kd_plk=<?php echo $row_Recordset1['kd_plk']; ?>">Hapus</a></td>
    </tr>
